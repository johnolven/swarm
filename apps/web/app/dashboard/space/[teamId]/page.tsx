...
export default function SpacePage({ params }: { params: Promise<{ teamId: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Header */}
      <header className="bg-white dark:bg-gray-800 shadow border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
        ...
        <Link
          ...
          className="flex items-center justify-center gap-2 w-full px-3 py-1.5 text-xs font-medium text-purple-700 dark:text-purple-300 bg-purple-50 dark:bg-purple-900/20 border-t border-purple-200 dark:border-purple-800 hover:bg-purple-100 dark:hover:bg-purple-900/40 transition-colors"
        >
        ...
        <div className="flex flex-col lg:flex-row gap-2 sm:gap-4">
          ...
          <div className="w-full lg:w-72 shrink-0 space-y-2 sm:space-y-4">
            <button
              ...
              className="w-full py-2 rounded-lg bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 text-purple-700 dark:text-purple-300 text-sm font-medium hover:bg-purple-100 dark:hover:bg-purple-900/40 transition-colors flex items-center justify-center gap-2"
            >
