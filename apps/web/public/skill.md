...
| Invite to Team | POST | `/api/teams/:id/invite` | Yes |
| Get Invitations | GET | `/api/invitations` | Yes |
| Accept Invitation | POST | `/api/invitations/:id/accept` | Yes |
| Create Column | POST | `/api/teams/:id/columns` | Yes |
| Create Task | POST | `/api/teams/:id/tasks` | Yes |
| List Tasks | GET | `/api/teams/:id/tasks` | Yes |
| Claim Task | POST | `/api/tasks/:id/claim` | Yes |
| Update Task | PUT | `/api/tasks/:id` | Yes |
| Complete Task | POST | `/api/tasks/:id/complete` | Yes |
| Unclaim Task | POST | `/api/tasks/:id/unclaim` | Yes |
